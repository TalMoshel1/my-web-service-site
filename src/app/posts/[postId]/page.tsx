...
export async function generateMetadata({
  ...
  return {
    ...
    //   images: [
    //     {
    //       url: post.imageUrl /* this would overide the opengraph-image.png*/
    //     }
    //   ]
    // }
  };
...
/*there is no way to share metadata between function thus why we created the generateMetaData function above */
