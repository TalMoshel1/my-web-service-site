          ...
          >
            ...
            <AnimatedOnScrollButNotOnLoad threshold={0.1}>
              ...
              >
                ...
                <div>
                  {/* <p>
                  פעם דפי אינטרנט היו שוקלים עשרות קילובייטים בודדים בלבד. היום זה לא המצב. גודל של דף סטנדרטי עם קבצי וידאו, אנימציות ולוגיקה מורכבת יכול להגיע לגודל של כמה מהגהבייט. אתר איטי או לא מקצועי מראה לגולש באתר את הדלת החוצה. לכן חשוב לדעת איך לייעל קבצי תמונות, וידאו, לכתוב HTML וCSS בצורה נכונה, להטמיע pagination ו-cache, וגם נגישות טובה תורמת לחווית משתמש בדרכים כמו שימוש נכון בצבעים, ביצוע פעולות באתר בעזרת מקש ה enter, tab ו shift וכמובן, לדייק את הכל מבחינה ויזואלית כך שיהיה אתר יפה ומרשים. בשביל זה אני כאן, ואני מביא איתי ניסיון של פרוייקטים שביצעתי, בהם חשבתי על הפרטים הקטנים, שימשכו את העין של המשתמש, מבלי לבלבל אותו ולהאט את האתר. 
                  קרא עוד על 
                  
                  <a className="link-in-text">בניית HTML נכונה</a>.
